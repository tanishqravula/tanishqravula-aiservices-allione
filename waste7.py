...
with st.sidebar:
    st.title("Tanishq DIY Recommender system")
...
if file is None:
    ...
    if class_names[np.argmax(predictions)] == 'trash':
        ...
        if st.button("Generate Video"):
            ...
            image_urls = ddg_images(title, max_results=16)
            image_urls = [item.get('image') for item in image_urls if 'image' in item]
            if len(image_urls) < num_images:
                
                st.warning("Some images could not be fetched from DuckDuckGo. Fetching from Bing...")
...
<br>
<a href="http://localhost:8502/">Send us your queries through this</a>
<br>
<a href="http://localhost:8501/">Ask Tanishq Ravulas bot for any questions</a>
