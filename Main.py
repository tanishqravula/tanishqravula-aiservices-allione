...
if prompt:
    ...
    if len(txt) > :
        txt = txt[:] + '...'
    if image or url != '':
        if url != '':
...
for message in st.session_state.chat_session:
    if message['user']['role'] == 'model':
        ...
        st.sidebar.markdown(f"**You:** {message['user']['
