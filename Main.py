...
#------------------------------------------------------------
#HEADER
#st.markdown('''Powered by Tanishq <img src="https://res.cloudinary.com/practicaldev/image/fetch/s--iU3HTvsb--/c_imagga_scale,f_auto,fl_progressive,h_900,q_auto,w_1600/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/d2utudhcrkw5ev8f8j0a.jpg">''', unsafe_allow_html=True)
