...
if prompt:
    ...
    if len(txt) > :
...
def display_history():
    for message in st.session_state.history:
        with st.sidebar.expander(message['user']['parts'][0], expanded=False):
            if message['user']['role'] == 'model':
                st.write(message['user']['parts'])
                graphs = extract_graphviz_info(message['user']['parts'])
